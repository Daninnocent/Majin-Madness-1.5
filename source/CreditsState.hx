...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			[''],
			[''],
			['Plusardx',			'plusardx',		'Director, Coder',											'https://www.youtube.com/channel/UC79hR4wLFO1fORZPaKY1XAw',		'444444'],
			[''],
			[''],
			['Alberton',				'alberton',		'Co-Director, Animator',														'https://www.youtube.com/channel/UCPOB2_LwLkVzFZ-4rXomjWQ',		'444444'],
			[''],
			[''],
			['Vegeth',			'vegeth',		'Charter',										'https://www.youtube.com/channel/UC5h7tAHmhpSAus09DIus6YA',		'444444'],
			[''],
			[''],
			['Abador',			'abador',		'Artist',										'https://twitter.com/cheddorcheese',		'444444'],
			[''],
			[''],
			...
			[''],
			[''],
			['VillArts',			'villagerhum',	'Musician (Upcoming V2), Artist',														'https://www.youtube.com/channel/UC52QcuYSAdeRks0WtTXSO6A',		'444444'],
			[''],
			[''],
			['Danly',				'danly',		'Musician',														'https://www.youtube.com/channel/UCM0BnEgf9acQc64rLqUfZ_A',		'444444'],
			[''],
			[''],
			['Haz',				'haz',		'Musician',														'https://www.youtube.com/channel/UCeWJLF0h_u75G01uadvLiIQ',		'444444'],
			[''],
			[''],
			['Daninnocent',			'daninnocent',	'Coder',														'https://www.youtube.com/channel/UCPddB_emjwVerq1RxsJLfDQ',		'444444'],
			[''],
			[''],
			['EnDev',				'endevgtnv',	'Coder (Retired)',														'https://www.youtube.com/channel/UCnw5m41Yud2t7uoI9NXQj2g',		'444444'],
			[''],
			[''],
			// We will miss you GTNV. Im not sad i swear.
		...
		for (i in 0...creditsStuff.length)
		{
			...
			var optionText:Alphabet = new Alphabet(-100, 70 * i, creditsStuff[i][0], true, true, true);
